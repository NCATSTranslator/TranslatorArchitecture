...
1. ReasonerAPI best practices:
   ...
   1. An ARA result is defined by the bindings of knowledge graph nodes to query graph nodes.  For a given set of node bindings, there can be only a single result.
